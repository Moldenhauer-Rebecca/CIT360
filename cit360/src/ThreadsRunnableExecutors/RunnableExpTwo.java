...
class RunnableExpTwo {
    ...
    public void setTaskData() {
        ...
        System.out.println("Task 1 is running on " + threadName);
    };
    
        this.task2 = () -> {
        String threadName = Thread.currentThread().getName();
        System.out.println("Task 2 is running on " + threadName);
    };
    
        this.task3 = () -> {
        String threadName = Thread.currentThread().getName();
        System.out.println("Task 3 is running on " + threadName);
    };
    }
